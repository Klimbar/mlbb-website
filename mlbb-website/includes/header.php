...
<head>
    ...
    <meta name="description"
        content="Top-up Mobile Legends: Bang Bang diamonds instantly and safely on serdihin.com. India's trusted site for MLBB top-ups with secure payments and fast delivery.">
    <title>
        <?php echo isset($page_title) ? htmlspecialchars($page_title) . ' | Serdihin' : 'Get MLBB Diamonds Safely | Serdihin – India\'s Trusted Top-Up Site'; ?>
    </title>
...
<body>
    <?php
    // Check for a "remember me" cookie to log the user in automatically
    check_remember_me();
    ?>
    <nav class="navbar navbar-expand-lg navbar-light bg-light sticky-top">
        <div class="container-fluid">
            <a class="navbar-brand d-flex align-items-center" href="<?php echo BASE_URL; ?>/">
                <img src="<?php echo BASE_URL; ?>/assets/serdihin_logo.webp?v=2" alt="Serdihin Logo" height="30"
                    class="me-1">
